...
COMMENT ON FUNCTION public.reporte_formas_pago_rendicion(DATE, DATE, BOOLEAN) IS
  'Reporte gerencial de formas de pago en rendiciones aprobadas. Usa clientes.razon_social / rif_nit.';
