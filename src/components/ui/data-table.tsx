...
export function DataTable({
  ...
  return (
    <>
      <div className="lt-print-hide space-y-3 md:hidden print:hidden">
        {rows.map((row) => (
          <article
            key={row.id}
      ...
      <div className="lt-print-table-wrap hidden overflow-x-auto rounded-xl border border-lt-border-light bg-lt-surface md:block print:block">
