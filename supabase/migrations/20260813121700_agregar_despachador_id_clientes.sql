-- Migración para agregar/corregir la columna despachador_id en la tabla clientes
-- Permite la asignación opcional de un usuario despachador a la ficha del cliente (relación 1:N con perfiles_usuario)
