-- Migración: RPC actualiza_registro_rutas_segun_uuid (Tarea DB-022)
...
COMMENT ON FUNCTION public.actualiza_registro_rutas_segun_uuid(UUID, TEXT, TEXT) IS 'Actualiza el nombre y descripción de una ruta existente identificada por su id_ruta (UUID)';
