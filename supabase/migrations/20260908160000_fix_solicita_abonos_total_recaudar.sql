-- Fix: solicita_abonos_orden_distribucion usaba od.subtotal_recaudar / od.subtotal
-- que no existen en ordenes_distribucion (sí total_recaudar_usd / total_recaudar_bs).
