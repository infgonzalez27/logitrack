...
-- 3. Script de Corrección de Datos Históricos en la Base de Datos
-- Corregir filas de detalle donde valor_unitario_usd era < 1 y valor_unitario_recaudar contenía el monto en USD
