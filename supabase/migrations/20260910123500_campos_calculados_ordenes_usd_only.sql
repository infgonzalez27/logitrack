...
-- Description: Omit calculation/storage of Bolívares fields (valor_unitario_recaudar, subtotal_recaudar, total_recaudar_bs) in order creation and update RPCs, maintaining calculations exclusively in USD, and update existing order records in database.

-- 0. Permitir valores NULL en los campos de Bolívares
...
-- 3. Script de Corrección de Registros Existentes en la Base de Datos
