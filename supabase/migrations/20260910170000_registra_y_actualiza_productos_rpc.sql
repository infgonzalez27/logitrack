-- Migración: Crear RPC registra_nuevo_producto_retorna_id y actualizar RPC actualizar_registro_productos_segun_id

-- 1. Función para registrar nuevo producto y retornar su ID
...
-- 2. Función para actualizar producto según ID
