...
-- Description: RPC para re-sincronizar y editar las órdenes de un radar existente en dos fases (desvinculación y revinculación) con validación de inventario cargado
