-- Migración: Módulo de Reporte de Formas de Pago por Rango de Fechas (Rendición de Cuentas)
...
-- 2. Marcar como bancarias/electrónicas las formas de pago correspondientes
